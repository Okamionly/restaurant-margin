    ...
    <AuthProvider>
      <ToastProvider>
        <RestaurantProvider>
          ...
          <Route path="/blog/tva-restaurant" element={<Suspense fallback={<div className="min-h-screen bg-white flex items-center justify-center"><Loader2 className="w-8 h-8 text-teal-500 animate-spin" /></div>}><BlogTvaRestaurant /></Suspense>} />
          <Route path="/blog/marge-boissons-restaurant" element={<Suspense fallback={<div className="min-h-screen bg-white flex items-center justify-center"><Loader2 className="w-8 h-8 text-teal-500 animate-spin" /></div>}><BlogMargeBoissons /></Suspense>} />
          ...
          <Route path="/blog/kpi-essentiels-restaurateur" element={<Suspense fallback={<div className="min-h-screen bg-white flex items-center justify-center"><Loader2 className="w-8 h-8 text-teal-500 animate-spin" /></div>}><BlogKpiRestaurateur /></Suspense>} />
          <Route path="/blog/reduire-cout-personnel-restaurant" element={<Suspense fallback={<div className="min-h-screen bg-white flex items-center justify-center"><Loader2 className="w-8 h-8 text-teal-500 animate-spin" /></div>}><BlogCoutPersonnel /></Suspense>} />
          ...
          <Route path="/blog/salaire-proprietaire-restaurant" element={<Suspense fallback={<div className="min-h-screen bg-white flex items-center justify-center"><Loader2 className="w-8 h-8 text-teal-500 animate-spin" /></div>}><BlogSalaireProprietaireRestaurant /></Suspense>} />
          ...
          <Route path="/blog/pourquoi-mon-restaurant-ne-rapporte-pas" element={<Suspense fallback={<div className="min-h-screen bg-white flex items-center justify-center"><Loader2 className="w-8 h-8 text-teal-500 animate-spin" /></div>}><BlogPourquoiPasRentable /></Suspense>} />
          ...
          <Route path="/blog/ouvrir-terrasse-restaurant-demarches" element={<Suspense fallback={<div className="min-h-screen bg-white flex items-center justify-center"><Loader2 className="w-8 h-8 text-teal-500 animate-spin" /></div>}><BlogOuvrirTerrasseRestaurant /></Suspense>} />
          <Route path="/blog/negocier-fournisseurs-restaurant" element={<Suspense fallback={<div className="min-h-screen bg-white flex items-center justify-center"><Loader2 className="w-8 h-8 text-teal-500 animate-spin" /></div>}><BlogNegocierFournisseurs /></Suspense>} />
          <Route path="/blog/reprise-restaurant-guide-acheteur" element={<Suspense fallback={<div className="min-h-screen bg-white flex items-center justify-center"><Loader2 className="w-8 h-8 text-teal-500 animate-spin" /></div>}><BlogRepriseRestaurant /></Suspense>} />
