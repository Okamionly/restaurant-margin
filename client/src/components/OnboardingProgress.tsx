        ...
        >
          {allDone && showCelebration ? (
            ...
            <>
              <div className="relative w-5 h-5 flex-shrink-0">
                <svg className="w-5 h-5 -rotate-90" viewBox="0 0 20 20">
                  ...
                  <circle
                    ...
                    className="text-[#111111] dark:text-white transition-all duration-500"
                    strokeLinecap="round"
                  />
                </svg>
              </div>
              ...
              {expanded ? (
                <ChevronUp className="w-3.5 h-3.5 text-[#9CA3AF] dark:text-[#737373]" />
              ) : (
                <ChevronDown className="w-3.5 h-3.5 text-[#9CA3AF] dark:text-[#737373]" />
              )}
            </>
          )}
        </button>
          ...
          <div className="px-3 py-2 space-y-1">
            ...
            <div className="flex items-center gap-2 py-1">
              {state.wizardCompleted ? (
                <div className="w-4 h-4 rounded bg-[#111111] dark:bg-white flex items-center justify-center flex-shrink-0">
                  <Check className="w-2.5 h-2.5 text-white dark:text-[#111111]" />
                </div>
              ) : (
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-2 py-1 text-left transition-colors rounded ${
                    !done ? 'hover:bg-[#F3F4F6] dark:hover:bg-[#1A1A1A] cursor-pointer' : ''
                  }`}
                >
                  {done ? (
                    <div className="w-4 h-4 rounded bg-[#111111] dark:bg-white flex items-center justify-center flex-shrink-0">
