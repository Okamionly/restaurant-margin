  ...
  return (
    ...
    >
      <div className="space-y-5">
        ...
        {/* Ingredient info */}
        <div className="flex items-center justify-between bg-mono-1000 dark:bg-mono-350/50 rounded-lg px-4 py-3">
          <div>
            <p className="text-sm text-mono-500 dark:text-mono-700">Ingrédient</p>
            <p className="font-semibold text-mono-300 dark:text-white">{ingredientName}</p>
          ...
          <div className="text-right">
            <p className="text-sm text-mono-500 dark:text-mono-700">Stock actuel</p>
            <p className="font-semibold text-mono-300 dark:text-white">{currentStock} {unit}</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
              useSimulation
                ...
                : 'bg-mono-975 dark:bg-mono-300 text-mono-400 dark:text-mono-800 border border-mono-900 dark:border-mono-350'
            }`}
          >
          ...
          <div className={`w-2.5 h-2.5 rounded-full ${
            isConnected ? 'bg-green-500' : status === 'connecting' ? 'bg-teal-500 animate-pulse' : 'bg-mono-700'
          }`} />
        </div>
        ...
        >
          ...
          <div className="relative z-10 flex items-baseline gap-2">
            ...
            <span className={`text-xl font-bold ${netWeight > 0 ? 'text-mono-700' : 'text-mono-350'}`}>
              {displayUnit}
            </span>
          </div>
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2">
          {/* Unit toggle */}
          <div className="flex items-center gap-1 p-1 bg-mono-975 dark:bg-mono-300 rounded-lg">
              ...
              <button
                ...
                className={`px-4 py-1.5 rounded-md text-sm font-bold transition-colors ${
                  displayUnit === u
                    ...
                    : 'text-mono-500 hover:text-mono-350 dark:hover:text-mono-800'
                }`}
              >
                {u}
              </button>
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 bg-mono-975 dark:bg-mono-300 hover:bg-mono-900 dark:hover:bg-mono-350 disabled:opacity-30 rounded-lg text-sm font-medium transition-colors"
          >
        ...
        {useSimulation && (
          <div className="flex items-center justify-center gap-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg px-4 py-3">
            ...
            <button
              ...
              className="w-12 h-12 rounded-lg bg-mono-900 dark:bg-mono-300 hover:bg-mono-800 dark:hover:bg-mono-350 flex items-center justify-center transition-colors"
            >
        ...
        <div className="flex flex-col sm:flex-row gap-3 pt-1">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-mono-400 hover:bg-mono-350 disabled:opacity-30 disabled:cursor-not-allowed text-white rounded-lg font-medium text-sm transition-colors"
          >
