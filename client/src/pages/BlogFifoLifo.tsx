      ...
      <main className="max-w-[720px] mx-auto px-6 sm:px-10 lg:px-12 pb-24 pt-8 bg-white relative z-10 rounded-t-3xl shadow-xl">
        ...
        <section id="fifo" className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-mono-100">1. FIFO : premier entré, premier sorti</h2>
          </div>
          ...
          <div className="bg-mono-975 rounded-xl p-4 text-sm text-[#374151]">
        ...
        <section id="lifo" className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-mono-100">2. LIFO : dernier entré, premier sorti</h2>
          </div>
          <p className="text-[#374151] leading-relaxed mb-4">
        ...
        <section id="comparaison" className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-mono-100">3. Comparatif FIFO vs LIFO</h2>
          </div>
          <div className="overflow-x-auto rounded-2xl border border-mono-900">
        ...
        <section id="mise-en-place" className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-mono-100">4. Mettre en place le FIFO en 5 étapes</h2>
          </div>
          ...
          <div className="space-y-5">
            {[
              ...
              <div key={num} className="flex gap-4">
                <div className="w-10 h-10 rounded-xl bg-mono-100 text-white text-sm font-bold flex items-center justify-center flex-shrink-0">{num}</div>
                <div>
                  <p className="font-semibold text-mono-100 mb-1">{title}</p>
                  <p className="text-sm text-mono-400 leading-relaxed">{text}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <section id="impact" className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-mono-100">5. Impact sur le food cost et la comptabilité</h2>
          </div>
          <p className="text-[#374151] leading-relaxed mb-4">
          ...
          <div className="overflow-x-auto rounded-2xl border border-mono-900 mb-5">
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-mono-975">
                  <th className="text-left px-4 py-3 font-semibold text-mono-100">CA mensuel</th>
                  <th className="text-center px-4 py-3 font-semibold text-mono-100">Food cost avant</th>
                  <th className="text-center px-4 py-3 font-semibold text-mono-100">Food cost après</th>
          ...
          <p className="text-sm text-mono-500">Estimations basées sur une réduction de 2 à 4 % du food cost après mise en place du FIFO structuré.</p>
        </section>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={q} className="border border-mono-900 rounded-xl p-5">
                ...
                <p className="text-sm text-mono-400 leading-relaxed">{a}</p>
              </div>
            ))}
          </div>
        </section>
