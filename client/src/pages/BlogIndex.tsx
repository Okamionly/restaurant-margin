...
const posts: BlogPost[] = [
  ...
  },
  {
    ...
    title: 'Marge beneficiaire restaurant : quel est l\'ideal en 2026 ?',
    excerpt: 'La marge beneficiaire ideale d\'un restaurant en France 2026 : 5-15 % en net selon le segment. Un benefice de 4 % est-il acceptable ? Une marge de 50 % est-elle realiste ? Reponses claires et exemples chiffres.',
    category: 'Marges',
    readTime: '10 min',
    date: '2026-05-26',
  },
  {
    ...
    excerpt: 'Pates, pizza, salade, soupe, dessert maison : le top 15 des plats les plus rentables avec marge brute, food cost et coefficient pour chacun. Comment construire une carte ultra-rentable.',
    category: 'Carte & Prix',
    readTime: '12 min',
    date: '2026-05-26',
  },
  {
    ...
    excerpt: 'Votre restaurant tourne mais ne rapporte rien ? Diagnostic des 10 causes principales : food cost qui derive, masse salariale, gaspillage, mauvaise carte, fournisseurs trop chers. Plan d\'action concret.',
    category: 'Pilotage',
    readTime: '11 min',
    date: '2026-05-26',
  },
  {
    ...
    excerpt: 'Salaire moyen d\'un proprietaire de restaurant en France : 30 a 80 keur/an selon segment, taille et ville. Decomposition des revenus, statut juridique (SARL/SAS), dividendes contre salaire, optimisation.',
    category: 'Gestion financière',
    readTime: '12 min',
    date: '2026-05-26',
  },
  {
    ...
    title: 'Regle 30/30/30/10 restaurant : le guide complet',
    excerpt: '30 % de food cost, 30 % de masse salariale, 30 % de charges, 10 % de marge nette : comprendre la regle, ses adaptations par segment, les calculs et les erreurs courantes.',
    category: 'Pilotage',
    readTime: '11 min',
    date: '2026-05-26',
  },
  {
    ...
    excerpt: 'Toutes les reponses sur la marge restaurant : taux moyen, calcul, regle 30/30/30/10, rentabilite, plat le plus rentable, salaire du proprietaire. 25 questions avec formules et benchmarks.',
    category: 'Marges',
    readTime: '14 min',
    date: '2026-05-26',
  },
  {
    ...
    excerpt: 'Ancrage, prix de charme, golden triangle, bundling : 7 techniques de psychologie des prix prouvees pour augmenter votre ticket moyen de 15 a 25 % sans toucher a vos recettes.',
    category: 'Pricing',
    readTime: '9 min',
    date: '2026-05-29',
  },
  {
    ...
    title: 'Negocier avec ses fournisseurs : 7 techniques',
    excerpt: 'Mise en concurrence, contrats-cadres, RFA, regroupement d\'achats : comment negocier efficacement avec vos fournisseurs et reduire votre food cost de 5 a 10 %.',
    category: 'Food Cost',
    readTime: '10 min',
    date: '2026-07-17',
  },
  {
    ...
    title: 'Gestion de la tresorerie restaurant : le plan 13 semaines',
    excerpt: 'Comment piloter la tresorerie de votre restaurant : plan previsionnel sur 13 semaines, 8 leviers pour ameliorer le cash disponible et les solutions d\'urgence en cas de tension.',
    category: 'Gestion financière',
    readTime: '10 min',
    date: '2026-07-31',
  },
  {
    ...
    title: 'Terrasse de restaurant : autorisations, demarches et rentabilite',
    excerpt: 'Droit de terrasse, dossier en mairie, equipement, chauffage et calcul de rentabilite : tout ce qu\'il faut pour ouvrir une terrasse de restaurant en France.',
    category: 'Réglementation',
    readTime: '12 min',
    date: '2026-07-10',
  },
  {
    ...
    excerpt: 'Audit comptable, valorisation du fonds de commerce, dettes cachees, negociation et financement : ce qu\'il faut verifier avant de racheter un restaurant.',
    category: 'Création',
    readTime: '10 min',
    date: '2026-07-25',
  },];
