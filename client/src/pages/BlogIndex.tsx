...
const posts: BlogPost[] = [
  ...
  {
    slug: 'menu-engineering-boston-matrix',
  ...
  },
  {
    ...
    title: 'Pourboires en restauration : législation, fiscalité et répartition 2026',
    excerpt: "À qui appartiennent les pourboires, comment les répartir sans perdre l'exonération, et jusqu'à quand l'exonération fiscale et sociale s'applique. Cas chiffré.",
    category: 'Juridique',
    readTime: '11 min',
    date: '2026-09-14',
  },
  ...
  {
    slug: 'marge-beneficiaire-restaurant-ideal',
    title: 'Marge bénéficiaire restaurant : quel est l\'idéal en 2026 ?',
    excerpt: 'La marge bénéficiaire idéale d\'un restaurant en France 2026 : 5-15 % en net selon le segment. Un bénéfice de 4 % est-il acceptable ? Une marge de 50 % est-elle réaliste ? Réponses claires et exemples chiffrés.',
    category: 'Marges',
    readTime: '10 min',
    date: '2026-05-26',
  },
  {
    slug: 'plat-le-plus-rentable-restaurant',
    title: 'Quel est le plat le plus rentable dans un restaurant ? (top 15)',
    excerpt: 'Pâtes, pizza, salade, soupe, dessert maison : le top 15 des plats les plus rentables avec marge brute, food cost et coefficient pour chacun. Comment construire une carte ultra-rentable.',
    category: 'Carte & Prix',
    readTime: '12 min',
    date: '2026-05-26',
  },
  {
    slug: 'pourquoi-mon-restaurant-ne-rapporte-pas',
    title: 'Pourquoi mon restaurant ne rapporte-t-il pas d\'argent ? 10 causes',
    excerpt: 'Votre restaurant tourne mais ne rapporte rien ? Diagnostic des 10 causes principales : food cost qui dérive, masse salariale, gaspillage, mauvaise carte, fournisseurs trop chers. Plan d\'action concret.',
    category: 'Pilotage',
    readTime: '11 min',
    date: '2026-05-26',
  },
  {
    slug: 'salaire-proprietaire-restaurant',
    title: 'Combien gagne un propriétaire de restaurant en 2026 ?',
    excerpt: 'Salaire moyen d\'un propriétaire de restaurant en France : 30 000 à 80 000 euros par an selon le segment, la taille et la ville. Décomposition des revenus, statut juridique (SARL/SAS), dividendes contre salaire, optimisation.',
    category: 'Gestion financière',
    readTime: '12 min',
    date: '2026-05-26',
  },
  {
    slug: 'regle-30-30-30-10-restaurant',
    title: 'Règle 30/30/30/10 restaurant : le guide complet',
    excerpt: '30 % de food cost, 30 % de masse salariale, 30 % de charges, 10 % de marge nette : comprendre la règle, ses adaptations par segment, les calculs et les erreurs courantes.',
    category: 'Pilotage',
    readTime: '11 min',
    date: '2026-05-26',
  },
  {
    slug: 'faq-marge-restaurant-25-questions',
    title: 'FAQ marge restaurant : 25 questions essentielles',
    excerpt: 'Toutes les réponses sur la marge restaurant : taux moyen, calcul, règle 30/30/30/10, rentabilité, plat le plus rentable, salaire du propriétaire. 25 questions avec formules et benchmarks.',
    category: 'Marges',
    readTime: '14 min',
    date: '2026-05-26',
  },
  {
    slug: 'psychologie-des-prix-restaurant',
    title: 'Psychologie des prix en restauration : 7 techniques',
    excerpt: 'Ancrage, prix de charme, golden triangle, bundling : 7 techniques de psychologie des prix prouvées pour augmenter votre ticket moyen de 15 à 25 % sans toucher à vos recettes.',
    category: 'Pricing',
    readTime: '9 min',
    date: '2026-05-29',
  },
  {
    slug: 'negocier-fournisseurs-restaurant',
    title: 'Négocier avec ses fournisseurs : 7 techniques',
    excerpt: 'Mise en concurrence, contrats-cadres, RFA, regroupement d\'achats : comment négocier efficacement avec vos fournisseurs et réduire votre food cost de 5 à 10 %.',
    category: 'Food Cost',
    readTime: '10 min',
    date: '2026-07-17',
  },
  {
    slug: 'gestion-tresorerie-restaurant',
    title: 'Gestion de la trésorerie restaurant : le plan 13 semaines',
    excerpt: 'Comment piloter la trésorerie de votre restaurant : plan prévisionnel sur 13 semaines, 8 leviers pour améliorer le cash disponible et les solutions d\'urgence en cas de tension.',
    category: 'Gestion financière',
    readTime: '10 min',
    date: '2026-07-31',
  },
  {
    ...
    title: 'Terrasse de restaurant : autorisations, démarches et rentabilité',
    excerpt: 'Droit de terrasse, dossier en mairie, équipement, chauffage et calcul de rentabilité : tout ce qu\'il faut pour ouvrir une terrasse de restaurant en France.',
    category: 'Réglementation',
    readTime: '12 min',
    date: '2026-07-10',
  },
  {
    ...
    title: 'Reprise de restaurant : le guide de l\'acheteur',
    excerpt: 'Audit comptable, valorisation du fonds de commerce, dettes cachées, négociation et financement : ce qu\'il faut vérifier avant de racheter un restaurant.',
    category: 'Création',
    readTime: '10 min',
    date: '2026-07-25',
  },];
