      ...
      <main className="max-w-[720px] mx-auto px-6 sm:px-10 lg:px-12 pb-24 pt-8 bg-white relative z-10 rounded-t-3xl shadow-xl">
        ...
        <section id="food-cost" className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-mono-100">1. Food Cost %</h2>
          </div>
        ...
        <section id="prime-cost" className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-mono-100">2. Prime Cost</h2>
          </div>
          <p className="text-[#374151] leading-relaxed mb-4">
        ...
        <section id="occupation" className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-mono-100">3. Taux d'occupation des tables</h2>
          </div>
          <p className="text-[#374151] leading-relaxed mb-4">
        ...
        <section id="ticket" className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-mono-100">4. Ticket moyen et CA par couvert</h2>
          </div>
          <p className="text-[#374151] leading-relaxed mb-4">
        ...
        <section id="revpash" className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-mono-100">5. RevPASH et point mort</h2>
          </div>
          <p className="text-[#374151] leading-relaxed mb-4">
        ...
        <section id="tableau-bord" className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-mono-100">6. Construire son tableau de bord</h2>
          </div>
