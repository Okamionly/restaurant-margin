        ...
        <section id="automatiser" className="mb-16">
          ...
          <div className="grid sm:grid-cols-2 gap-6 mt-8">
            {[
              ...
              { icon: <BarChart3 className="w-5 h-5" />, title: 'Benchmark automatique', desc: 'Comparez votre tarification a la mediane du marche local (quand la donnee locale est disponible). Identifiez les plats sous-tarifees et les plats sur-tarifees.' },
