      ...
      <main className="max-w-[720px] mx-auto px-6 sm:px-10 lg:px-12 pb-24 pt-8 bg-white relative z-10 rounded-t-3xl shadow-xl">
        ...
        <section id="definition" className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-mono-100">1. Définition et formule</h2>
          </div>
        ...
        <section id="cruciale" className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-mono-100">2. Pourquoi la rotation est cruciale</h2>
          </div>
        ...
        <section id="calcul" className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-mono-100">3. Calcul détaillé avec exemple</h2>
          </div>
          <p className="text-[#374151] leading-relaxed mb-4">
        ...
        <section id="benchmarks" className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-mono-100">4. Benchmarks par catégorie de produits</h2>
          </div>
          <p className="text-[#374151] leading-relaxed mb-4">
        ...
        <section id="leviers" className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-mono-100">5. Les 6 leviers d'optimisation</h2>
          </div>
          <ul className="space-y-3 text-[#374151] mb-4">
            <li className="flex items-start gap-2">
        ...
        <section id="impact" className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-mono-100">6. Impact d'une mauvaise rotation</h2>
          </div>
          <p className="text-[#374151] leading-relaxed mb-4">
