      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="space-y-10">
          ...
          <section className="bg-mono-1000 dark:bg-mono-50 border border-mono-900 dark:border-mono-200 rounded-2xl p-6 space-y-3">
            ...
            <p className="text-mono-350 dark:text-mono-800">
              <span className="font-medium text-mono-100 dark:text-white">4.1</span> La Plateforme propose les fonctionnalites suivantes, sous reserve de l'abonnement souscrit par l'Utilisateur :
            </p>
          ...
          <section className="bg-mono-1000 dark:bg-mono-50 border border-mono-900 dark:border-mono-200 rounded-2xl p-6 space-y-3">
            ...
            <p className="text-mono-350 dark:text-mono-800">
              <span className="font-medium text-mono-100 dark:text-white">7.3</span> L'Utilisateur dispose d'un droit d'acces, de rectification, d'effacement, de limitation du traitement, de portabilite des donnees et d'opposition au traitement de ses donnees personnelles, qu'il peut exercer en contactant la Societe a l'adresse contact@restaumargin.fr. L'Utilisateur dispose egalement du droit de definir des directives relatives au sort de ses donnees personnelles apres son deces, conformement a l'article 85 de la loi n° 78-17 du 6 janvier 1978 modifiee.
            </p>
          </section>
          ...
          <section className="bg-mono-1000 dark:bg-mono-50 border border-mono-900 dark:border-mono-200 rounded-2xl p-6 space-y-3">
            ...
            <div className="text-mono-350 dark:text-mono-800 space-y-1">
              ...
              <p><span className="text-mono-500">Email :</span>{' '}
