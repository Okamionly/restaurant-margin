      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="space-y-10">
          ...
          <section className="bg-[#FAFAFA] dark:bg-[#0A0A0A] border border-[#E5E7EB] dark:border-[#1A1A1A] rounded-2xl p-6 space-y-3">
            ...
            <p className="text-[#404040] dark:text-[#D4D4D4]">
              <span className="font-medium text-[#111111] dark:text-white">2.1</span> Les presentes CGV ont pour objet de definir les droits et obligations respectifs des parties dans le cadre de la vente des Services et des Produits proposes par la Societe au Client, qu'il s'agisse de la souscription a un Abonnement a la Plateforme, de l'achat d'un Kit Hardware, ou de tout autre produit ou service commercialise par la Societe. Les presentes CGV regissent l'ensemble des etapes necessaires a la passation de la commande, depuis la souscription jusqu'a la facturation, la livraison et le service apres-vente.
            </p>
            <p className="text-[#404040] dark:text-[#D4D4D4]">
              <span className="font-medium text-[#111111] dark:text-white">2.2</span> La Societe propose les services et produits suivants :
            </p>
            <ul className="list-disc list-inside text-[#404040] dark:text-[#D4D4D4] space-y-2 ml-2">
              <li>
                <span className="font-medium text-[#111111] dark:text-white">Abonnement SaaS</span> : acces a la plateforme de gestion de marge pour la restauration, incluant la gestion des ingredients, les fiches techniques, les menus, les inventaires, les commandes, la comptabilite, les outils d'intelligence artificielle, le menu engineering, la mercuriale des prix, le scanner de factures, le suivi HACCP et la tracabilite, ainsi que l'ensemble des fonctionnalites disponibles sur la Plateforme.
              </li>
              <li>
                <span className="font-medium text-[#111111] dark:text-white">Kit Hardware</span> : un ensemble materiel comprenant une tablette preconfigured et une balance connectee, destine a la pesee et au controle des portions en cuisine, livre preconfigure avec l'application RestauMargin.
              </li>
              <li>
                <span className="font-medium text-[#111111] dark:text-white">Services complementaires</span> : tout service additionnel qui pourrait etre propose par la Societe, incluant sans s'y limiter les services de formation, d'accompagnement a la mise en place, de personnalisation, de developpement sur mesure, ou de conseil en gestion de restauration.
              </li>
            </ul>
          </section>
          ...
          <section className="bg-[#FAFAFA] dark:bg-[#0A0A0A] border border-[#E5E7EB] dark:border-[#1A1A1A] rounded-2xl p-6 space-y-3">
            ...
            <div className="text-[#404040] dark:text-[#D4D4D4] space-y-1">
              <p><span className="text-[#737373]">Raison sociale :</span> RestauMargin SAS</p>
