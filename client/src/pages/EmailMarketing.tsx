    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-mono-500 dark:text-mono-700 text-sm mt-1">
      ...
      {/* Tabs */}
      <div className="flex gap-1 bg-mono-975 dark:bg-[#171717] rounded-xl p-1 overflow-x-auto">
        {tabs.map(tab => {
          const Icon = tab.icon;
          return (
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium whitespace-nowrap transition-all ${
                activeTab === tab.id
                  ? 'bg-white dark:bg-mono-50 text-mono-100 dark:text-white shadow-sm'
                  : 'text-mono-500 dark:text-mono-700 hover:text-mono-100 dark:hover:text-white'
              }`}
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white dark:bg-mono-50/50 border border-mono-900 dark:border-mono-200 rounded-2xl p-5">
              <label className="block text-sm font-semibold text-mono-100 dark:text-white mb-2">
                Nom de la campagne
              </label>
              <input
                type="text"
                ...
                className="w-full px-4 py-3 bg-mono-975 dark:bg-mono-300 border border-mono-900 dark:border-mono-300 rounded-lg text-mono-100 dark:text-white placeholder-[#9CA3AF] focus:outline-none focus:ring-2 focus:ring-teal-500"
              />
            </div>

            {/* Template selection */}
            <div className="bg-white dark:bg-mono-50/50 border border-mono-900 dark:border-mono-200 rounded-2xl p-5">
              <label className="block text-sm font-semibold text-mono-100 dark:text-white mb-3">
                Template
              </label>
                    ...
                    <button
                      ...
                      className={`flex items-center gap-3 px-4 py-3 rounded-xl border-2 transition-all text-left ${
                        selectedTemplate === id
                          ...
                          : 'border-mono-900 dark:border-mono-300 hover:border-[#D1D5DB] dark:hover:border-mono-350'
                      }`}
                    >
                      <Icon className={`w-5 h-5 flex-shrink-0 ${meta.color}`} />
                      <div className="min-w-0">
                        <div className="text-sm font-medium text-mono-100 dark:text-white">{meta.label}</div>
                        <div className="text-xs text-mono-500 dark:text-mono-700 truncate">{meta.description}</div>
                      </div>
                    </button>
                  );
                })}
            ...
            <div className="bg-white dark:bg-mono-50/50 border border-mono-900 dark:border-mono-200 rounded-2xl p-5">
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all ${
                      recipientType === opt.id
                        ...
                        : 'bg-mono-975 dark:bg-mono-300 text-mono-500 dark:text-mono-700 hover:bg-mono-900 dark:hover:bg-[#333]'
                    }`}
                  >
                    {opt.label}
                  ...
                  {([
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="text-xs font-medium text-mono-100 dark:text-white">{s.label}</span>
                        <span className="text-xs text-mono-500 dark:text-mono-700">{s.count}</span>
                      </button>
                    );
                  })}
                </div>
              ...
              {recipientType === 'manual' && (
                <textarea
                  ...
                  rows={4}
                  className="w-full px-4 py-3 bg-mono-975 dark:bg-mono-300 border border-mono-900 dark:border-mono-300 rounded-lg text-mono-100 dark:text-white placeholder-[#9CA3AF] focus:outline-none focus:ring-2 focus:ring-teal-500 resize-none text-sm"
                />
              )}
            </div>
              ...
              <div className="flex gap-2 mb-3">
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all ${
                    scheduleType === 'now'
                      ? 'bg-mono-100 dark:bg-white text-white dark:text-mono-100'
                      : 'bg-mono-975 dark:bg-mono-300 text-mono-500 dark:text-mono-700'
                  }`}
                >
              ...
              {scheduleType === 'scheduled' && (
                <div className="flex gap-3">
                  <input
                    ...
                    className="flex-1 px-4 py-2.5 bg-mono-975 dark:bg-mono-300 border border-mono-900 dark:border-mono-300 rounded-lg text-mono-100 dark:text-white focus:outline-none focus:ring-2 focus:ring-teal-500"
                  />
                  <input
                    type="time"
                    value={scheduledTime}
                    onChange={e => setScheduledTime(e.target.value)}
                    className="w-28 px-4 py-2.5 bg-mono-975 dark:bg-mono-300 border border-mono-900 dark:border-mono-300 rounded-lg text-mono-100 dark:text-white focus:outline-none focus:ring-2 focus:ring-teal-500"
                  />
                </div>
              )}
            </div>
          ...
          {/* Right: Preview */}
          <div className="bg-white dark:bg-mono-50/50 border border-mono-900 dark:border-mono-200 rounded-2xl p-5 lg:sticky lg:top-6 self-start">
            ...
            <div className="border border-mono-900 dark:border-mono-300 rounded-xl overflow-hidden">
              {/* Email header */}
              <div className="bg-mono-975 dark:bg-[#171717] px-4 py-3 border-b border-mono-900 dark:border-mono-300">
                ...
                <div className="space-y-1">
                  <div className="flex items-center gap-2 text-xs">
                    <span className="text-mono-500 dark:text-mono-700">De:</span>
                    <span className="text-mono-100 dark:text-white">RestauMargin &lt;contact@restaumargin.fr&gt;</span>
                  </div>
                  <div className="flex items-center gap-2 text-xs">
                    <span className="text-mono-500 dark:text-mono-700">Objet:</span>
                    <span className="text-mono-100 dark:text-white font-medium">{customSubject}</span>
                  </div>
                </div>
              </div>
              {/* Email body */}
              <div className="p-4 bg-mono-1000 dark:bg-mono-50 max-h-[500px] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 bg-mono-975 dark:bg-[#171717] border border-mono-900 dark:border-mono-200 rounded-xl text-mono-100 dark:text-white placeholder-[#9CA3AF] focus:outline-none focus:ring-2 focus:ring-teal-500"
            />
          </div>
            ...
            {filteredHistory.map(campaign => {
              ...
              return (
                <div
                  ...
                  className="bg-white dark:bg-mono-50/50 border border-mono-900 dark:border-mono-200 rounded-2xl p-5 hover:border-teal-300 dark:hover:border-teal-700 transition-colors cursor-pointer"
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-start gap-3 min-w-0">
                      <div className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${
                        campaign.status === 'sent' ? 'bg-emerald-50 dark:bg-emerald-900/20'
                        : campaign.status === 'finished' ? 'bg-mono-975 dark:bg-mono-300'
                        : campaign.status === 'scheduled' ? 'bg-blue-50 dark:bg-blue-900/20'
                        : campaign.status === 'draft' ? 'bg-amber-50 dark:bg-amber-900/20'
                        : 'bg-mono-975 dark:bg-mono-300'
                      }`}>
                        <TIcon className={`w-5 h-5 ${meta.color}`} />
                      </div>
                      <div className="min-w-0">
                        <h3 className="text-sm font-semibold text-mono-100 dark:text-white truncate">{campaign.name}</h3>
                        <div className="flex items-center gap-3 mt-1 text-xs text-mono-500 dark:text-mono-700">
                    ...
                    <div className="flex items-center gap-3">
                      <span className={`px-2.5 py-1 rounded-full text-xs font-medium ${
                        ...
                        : campaign.status === 'finished' ? 'bg-mono-975 dark:bg-mono-300 text-mono-400 dark:text-mono-700'
                      ...
                      {(campaign.status === 'sent' || campaign.status === 'finished') && (
                        <span className="text-sm font-semibold text-mono-100 dark:text-white">{openRate}%</span>
                      )}
                      <button
                        onClick={e => { e.stopPropagation(); handleDeleteCampaign(campaign.id); }}
                        className="p-1.5 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 text-mono-500 hover:text-red-500 transition-colors"
                      >
                        <Trash2 className="w-4 h-4" />
                      </button>
                      <ChevronDown className={`w-4 h-4 text-mono-500 transition-transform ${selectedCampaign?.id === campaign.id ? 'rotate-180' : ''}`} />
                    </div>
                  </div>
                  ...
                  {selectedCampaign?.id === campaign.id && (campaign.status === 'sent' || campaign.status === 'finished') && (
                    <div className="mt-4 pt-4 border-t border-mono-900 dark:border-mono-200">
                      <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
                        {[
                          { label: 'Envoyes', value: campaign.stats.sent, color: 'text-mono-100 dark:text-white' },
                          ...
                          <div key={stat.label} className="text-center p-3 bg-mono-975 dark:bg-[#171717] rounded-xl">
                            <div className={`text-lg font-bold ${stat.color}`}>{stat.value}</div>
                            <div className="text-xs text-mono-500 dark:text-mono-700">{stat.label}</div>
                          </div>
                        ))}
                      </div>
                    </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-5">
            <div className="bg-white dark:bg-mono-50/50 border border-mono-900 dark:border-mono-200 rounded-2xl p-5">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-xs font-medium text-mono-500 dark:text-mono-700 mb-1.5">
                    Nom du restaurant
                  </label>
                  <input
                    type="text"
                    ...
                    className="w-full px-4 py-3 bg-mono-975 dark:bg-mono-300 border border-mono-900 dark:border-mono-300 rounded-lg text-mono-100 dark:text-white focus:outline-none focus:ring-2 focus:ring-teal-500"
                  />
                </div>
                <div>
                  <label className="block text-xs font-medium text-mono-500 dark:text-mono-700 mb-1.5">
                  ...
                  <div className="px-4 py-3 bg-mono-975 dark:bg-mono-300 rounded-lg text-sm font-mono text-teal-600 dark:text-teal-400">
            ...
            <div className="bg-white dark:bg-mono-50/50 border border-mono-900 dark:border-mono-200 rounded-2xl p-5">
              <div className="flex items-center justify-between mb-3">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-mono-100 dark:bg-white text-white dark:text-mono-100 rounded-lg text-xs font-medium hover:opacity-90 transition-opacity"
                >
          ...
          {/* Preview */}
          <div className="bg-white dark:bg-mono-50/50 border border-mono-900 dark:border-mono-200 rounded-2xl p-5 self-start lg:sticky lg:top-6">
            <h3 className="text-sm font-semibold text-mono-100 dark:text-white mb-4 flex items-center gap-2">
              <Eye className="w-4 h-4 text-teal-500" />
              Apercu du widget
            </h3>
            <div className="border border-mono-900 dark:border-mono-300 rounded-xl p-6 bg-mono-1000 dark:bg-mono-50">
                  ...
                  <div key={step.id}>
                    ...
                    {index > 0 && (
                      <div className="flex items-center ml-5 py-1">
                        <div className="w-px h-8 bg-mono-900 dark:bg-mono-300" />
                        <div className="ml-4 flex items-center gap-2 text-xs text-mono-500 dark:text-mono-700">
                    ...
                    <div className={`flex items-center gap-4 p-4 rounded-xl border-2 transition-all ${
                      step.active
                        ...
                        : 'border-mono-900 dark:border-mono-300 opacity-50'
                    }`}>
                      <div className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${
                        step.active
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          <span className="text-xs px-2 py-0.5 rounded-full bg-mono-975 dark:bg-mono-300 text-mono-500 dark:text-mono-700 font-medium">
                            J+{step.day}
                          </span>
                          <span className="text-sm font-medium text-mono-100 dark:text-white truncate">
                            {step.subject}
                          </span>
                        </div>
                        {step.condition && (
                      ...
                      <div className="flex items-center gap-2">
                        <span className={`text-xs font-medium px-2 py-1 rounded-lg ${
                          step.active
                            ...
                            : 'bg-mono-975 dark:bg-mono-300 text-mono-500'
                        }`}>
                          {meta.label}
                        </span>
                        <button
                          ...
                          className={`p-2 rounded-lg transition-colors ${
                            step.active
                              ...
                              : 'hover:bg-emerald-50 dark:hover:bg-emerald-900/20 text-mono-500 hover:text-emerald-500'
                          }`}
      ...
      {activeTab === 'analytics' && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            {[
              { label: 'Envoyes', value: analyticsData.totalSent, icon: Send, color: 'text-mono-100 dark:text-white', bg: 'bg-mono-975 dark:bg-[#171717]' },
              ...
              return (
                <div key={kpi.label} className="bg-white dark:bg-mono-50/50 border border-mono-900 dark:border-mono-200 rounded-2xl p-4">
                  ...
                  <div className="text-xs text-mono-500 dark:text-mono-700 mt-0.5">{kpi.label}</div>
                </div>
              );
            })}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Rates */}
            <div className="bg-white dark:bg-mono-50/50 border border-mono-900 dark:border-mono-200 rounded-2xl p-5">
              <h3 className="text-sm font-semibold text-mono-100 dark:text-white mb-4">Taux de performance</h3>
              <div className="space-y-4">
                {[
                  ...
                  <div key={rate.label}>
                    <div className="flex items-center justify-between mb-1.5">
                      <span className="text-sm text-mono-500 dark:text-mono-700">{rate.label}</span>
                      <span className="text-sm font-semibold text-mono-100 dark:text-white">{rate.value}%</span>
                    </div>
            ...
            <div className="space-y-4">
              <div className="bg-white dark:bg-mono-50/50 border border-mono-900 dark:border-mono-200 rounded-2xl p-5">
                <h3 className="text-sm font-semibold text-mono-100 dark:text-white mb-3">Meilleur template</h3>
                {(() => {
                  ...
                  return (
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-base font-semibold text-mono-100 dark:text-white">{meta.label}</div>
                        <div className="text-sm text-mono-500 dark:text-mono-700">
              ...
              <div className="bg-white dark:bg-mono-50/50 border border-mono-900 dark:border-mono-200 rounded-2xl p-5">
                <h3 className="text-sm font-semibold text-mono-100 dark:text-white mb-3">Meilleur moment d'envoi</h3>
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-xl bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center">
                    <Clock className="w-6 h-6 text-blue-500" />
                  </div>
                  <div>
                    <div className="text-base font-semibold text-mono-100 dark:text-white">Mardi 10h00</div>
                    <div className="text-sm text-mono-500 dark:text-mono-700">
              ...
              <div className="bg-white dark:bg-mono-50/50 border border-mono-900 dark:border-mono-200 rounded-2xl p-5">
                <h3 className="text-sm font-semibold text-mono-100 dark:text-white mb-3">Par campagne</h3>
                  ...
                  {analyticsData.sentCampaigns.slice(0, 4).map(c => {
                    ...
                    return (
                      <div key={c.id} className="flex items-center justify-between">
                        <span className="text-sm text-mono-500 dark:text-mono-700 truncate flex-1 mr-3">{c.name}</span>
                        <div className="flex items-center gap-3 flex-shrink-0">
                          <div className="w-20 h-1.5 bg-mono-975 dark:bg-mono-300 rounded-full overflow-hidden">
                            <div className="h-full bg-emerald-500 rounded-full" style={{ width: `${openRate}%` }} />
                          </div>
                          <span className="text-xs font-medium text-mono-100 dark:text-white w-8 text-right">{openRate}%</span>
                        </div>
                      </div>
                    );
                  })}
