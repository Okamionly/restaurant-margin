      ...
      <div className="flex items-start justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400">{integ.description}</p>
          </div>
        </div>
        {integ.comingSoon ? (
          ...
          <span className="px-2.5 py-1 text-xs font-medium rounded-full bg-slate-100 dark:bg-slate-700 text-slate-500 dark:text-slate-400">
            Non connecte
          </span>
        )}
      </div>
      ...
      <section className="bg-white dark:bg-slate-800 rounded-xl border dark:border-slate-700 p-6 space-y-5">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="flex gap-2">
            <button
              onClick={copyApiKey}
              className="flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors"
            >
        ...
        <div>
          <div className="flex items-center justify-between text-sm mb-1.5">
            <span className="text-slate-600 dark:text-slate-400">Utilisation ce mois</span>
            <span className="font-medium text-slate-700 dark:text-slate-300">1 247 / 10 000 requetes</span>
          </div>
          ...
          {webhooks.map(wh => (
            ...
            >
              <div className="sm:w-40 flex-shrink-0">
                <span className="text-sm font-medium text-slate-700 dark:text-slate-300">{wh.name}</span>
                {wh.lastTriggered && (
              ...
              <input
                ...
                className="flex-1 px-3 py-2 text-sm border dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
              />
              <div className="flex items-center gap-2">
                {/* Toggle */}
                <button
