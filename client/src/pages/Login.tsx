              ...
              {isForgotPassword ? (
                ...
                <>
                  ...
                  <div className="space-y-3 mb-2">
                    ...
                    {/* FIX 2026-04-28 (audit Karim persona) : bouton Apple cache jusqu'a
                        implementation reelle Sign in with Apple. Avant : un click
                        affichait toast "bientot disponible" = mauvaise UX (faux CTA). */}
                  </div>
