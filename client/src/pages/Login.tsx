...
export default function Login() {
  ...
  // null = en cours de check ; true/false = config server-side
            ...
            >
              ...
              {isForgotPassword ? (
                ...
                <>
                  ...
                  {/* OAuth buttons — affiche Google uniquement si configure server-side
                      (cf /api/auth/google/status). Avant : bouton toujours visible
                      meme sans GOOGLE_CLIENT_ID env -> click = HTTP 500 visible user.
                      Apres : check status au mount, render conditionnel. */}
                  {googleEnabled && (
                  ...
                  {/* Separator — affiché uniquement si Google est dispo (sinon le "ou"
                      n'a plus de sens, le user voit juste le form email). */}
                  {googleEnabled && (
