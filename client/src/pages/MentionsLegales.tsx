      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="space-y-10">
          ...
          <section className="bg-mono-1000 dark:bg-mono-50 border border-mono-900 dark:border-mono-200 rounded-2xl p-6 space-y-3">
            ...
            <p className="text-mono-350 dark:text-mono-800">
              <span className="font-medium text-mono-100 dark:text-white">2.1</span> Le Site est edite par RestauMargin SAS (ci-apres « la Societe »), societe par actions simplifiee au capital social variable, immatriculee au Registre du Commerce et des Societes de Marseille, dont le siege social est etabli a Marseille, France.
            </p>
          ...
          <section className="bg-mono-1000 dark:bg-mono-50 border border-mono-900 dark:border-mono-200 rounded-2xl p-6 space-y-3">
            ...
            <p className="text-mono-350 dark:text-mono-800">
              <span className="font-medium text-mono-100 dark:text-white">3.1</span> Le directeur de la publication du Site est le representant legal de la Societe, en sa qualite de President de RestauMargin SAS. Conformement aux dispositions de l'article 6-III de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'economie numerique, le directeur de la publication est la personne qui determine les contenus et les services mis en ligne sur le Site, et qui assume la responsabilite editoriale de l'ensemble des contenus publies sur le Site.
            </p>
            <p className="text-mono-350 dark:text-mono-800">
          ...
          <section className="bg-mono-1000 dark:bg-mono-50 border border-mono-900 dark:border-mono-200 rounded-2xl p-6 space-y-3">
            ...
            <p className="text-mono-350 dark:text-mono-800">
              <span className="font-medium text-mono-100 dark:text-white">7.1</span> L'ensemble des elements composant le Site et les Services, incluant sans s'y limiter les textes, images, photographies, illustrations, graphiques, logos, marques, denominations sociales, noms de domaine, logiciels, programmes informatiques, codes sources, codes objets, algorithmes, bases de donnees, charte graphique, design, architecture, interfaces, fonctionnalites, sons, videos, animations, et plus generalement tout element protegeable par le droit de la propriete intellectuelle, sont la propriete exclusive de RestauMargin SAS ou de ses concedants de licence, et sont proteges par les lois francaises et internationales relatives a la propriete intellectuelle, et notamment par le Code de la propriete intellectuelle, le droit d'auteur, le droit des marques, le droit des dessins et modeles, le droit des brevets et le droit sui generis des bases de donnees.
            </p>
            <p className="text-mono-350 dark:text-mono-800">
