      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="space-y-10">
          ...
          <section className="bg-[#FAFAFA] dark:bg-[#0A0A0A] border border-[#E5E7EB] dark:border-[#1A1A1A] rounded-2xl p-6 space-y-3">
            ...
            <p className="text-[#404040] dark:text-[#D4D4D4]">
              <span className="font-medium text-[#111111] dark:text-white">2.1</span> Le Site est edite par RestauMargin SAS (ci-apres « la Societe »), societe par actions simplifiee au capital social variable, immatriculee au Registre du Commerce et des Societes de Marseille, dont le siege social est etabli a Marseille, France.
            </p>
          ...
          <section className="bg-[#FAFAFA] dark:bg-[#0A0A0A] border border-[#E5E7EB] dark:border-[#1A1A1A] rounded-2xl p-6 space-y-3">
            ...
            <p className="text-[#404040] dark:text-[#D4D4D4]">
              <span className="font-medium text-[#111111] dark:text-white">3.1</span> Le directeur de la publication du Site est le representant legal de la Societe, en sa qualite de President de RestauMargin SAS. Conformement aux dispositions de l'article 6-III de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'economie numerique, le directeur de la publication est la personne qui determine les contenus et les services mis en ligne sur le Site, et qui assume la responsabilite editoriale de l'ensemble des contenus publies sur le Site.
            </p>
            <p className="text-[#404040] dark:text-[#D4D4D4]">
              <span className="font-medium text-[#111111] dark:text-white">3.2</span> Le directeur de la publication peut etre contacte a l'adresse electronique suivante : contact@restaumargin.fr. Toute notification, mise en demeure ou correspondance officielle relative au contenu editorial du Site doit etre adressee au directeur de la publication a l'adresse du siege social de la Societe ou par voie electronique a l'adresse precitee.
            </p>
            <p className="text-[#404040] dark:text-[#D4D4D4]">
              <span className="font-medium text-[#111111] dark:text-white">3.3</span> Le directeur de la publication veille a ce que les contenus publies sur le Site respectent les dispositions legales et reglementaires applicables, et notamment les dispositions relatives a la propriete intellectuelle, au droit a l'image, au respect de la vie privee, a l'ordre public et aux bonnes moeurs. En cas de signalement de contenu illicite, le directeur de la publication s'engage a prendre les mesures necessaires dans les meilleurs delais pour retirer ou rendre inaccessible le contenu en question, conformement aux dispositions de la LCEN.
            </p>
          </section>
