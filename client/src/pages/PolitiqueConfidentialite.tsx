      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="space-y-10">
          ...
          <section className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 space-y-3">
            ...
            <p className="text-slate-300">
              <span className="font-medium text-white">2.1</span> Le responsable du traitement des donnees a caractere personnel collectees et traitees dans le cadre de l'utilisation du Site et des Services est :
            </p>
          ...
          <section className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 space-y-3">
            ...
            <p className="text-slate-300">
              <span className="font-medium text-white">3.1</span> Dans le cadre de l'exploitation du Site et de la fourniture des Services, la Societe collecte et traite les categories de donnees personnelles suivantes :
            </p>

            <div className="space-y-4 mt-4">
              <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700">
                <h3 className="font-medium text-white mb-2">3.1.1 Donnees d'identification et de contact</h3>
              ...
              <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700">
                <h3 className="font-medium text-white mb-2">3.1.2 Donnees de connexion et donnees techniques</h3>
                <p className="text-slate-300 text-sm">
              ...
              <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700">
                <h3 className="font-medium text-white mb-2">3.1.3 Donnees metier et donnees professionnelles</h3>
                <p className="text-slate-300 text-sm">
              ...
              <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700">
                <h3 className="font-medium text-white mb-2">3.1.4 Donnees de paiement et donnees de facturation</h3>
                <p className="text-slate-300 text-sm">
              ...
              <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700">
                <h3 className="font-medium text-white mb-2">3.1.5 Donnees de communication et de support</h3>
                <p className="text-slate-300 text-sm">
          ...
          <section className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 space-y-3">
            ...
            <p className="text-slate-300">
              <span className="font-medium text-white">4.1</span> Les donnees personnelles collectees par la Societe sont traitees pour les finalites suivantes, chacune reposant sur une base legale specifique conformement a l'article 6 du RGPD :
            </p>
              ...
              <table className="w-full text-sm mt-2">
                <thead>
                  <tr className="border-b border-slate-700">
                    ...
                    <th className="text-left py-3 px-4 text-slate-400 font-medium">Base legale</th>
                  </tr>
                </thead>
              ...
              <table className="w-full text-sm mt-2">
                <thead>
                  <tr className="border-b border-slate-700">
                    ...
                    <th className="text-left py-3 px-4 text-slate-400 font-medium">Duree de conservation</th>
                    <th className="text-left py-3 px-4 text-slate-400 font-medium">Fondement</th>
                  </tr>
                </thead>
                <tbody className="text-slate-300">
                  <tr className="border-b border-slate-800">
          ...
          <section className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 space-y-3">
            ...
            <div className="space-y-4 mt-4">
              ...
              <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700">
                <h3 className="font-medium text-white mb-1">7.1.2 Cookies analytiques et de mesure d'audience</h3>
                <p className="text-slate-300 text-sm">
              ...
              <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700">
                <h3 className="font-medium text-white mb-1">7.1.3 Cookies fonctionnels</h3>
                <p className="text-slate-300 text-sm">
          ...
          <section className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 space-y-3">
            ...
            <p className="text-slate-300">
              <span className="font-medium text-white">10.2</span> Les mesures de securite mises en oeuvre incluent notamment, sans s'y limiter :
            </p>
          ...
          <section className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 space-y-3">
            ...
            <div className="text-slate-300 space-y-1">
              <p><span className="text-slate-400">Denomination sociale :</span> RestauMargin SAS</p>
              <p><span className="text-slate-400">Qualite :</span> Responsable du traitement des donnees a caractere personnel</p>
              <p><span className="text-slate-400">Siege social :</span> Marseille, France</p>
