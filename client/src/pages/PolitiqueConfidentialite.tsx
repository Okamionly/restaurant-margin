  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black text-mono-100 dark:text-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        ...
        <p className="text-mono-500 mb-10">Derniere mise a jour : 7 avril 2026</p>
        ...
        <div className="space-y-10">
          ...
          <section className="bg-mono-1000 dark:bg-mono-50 border border-mono-900 dark:border-mono-200 rounded-2xl p-6 space-y-3">
            ...
            <p className="text-mono-350 dark:text-mono-800">
              <span className="font-medium text-mono-100 dark:text-white">3.1</span> Dans le cadre de l'exploitation du Site et de la fourniture des Services, la Societe collecte et traite les categories de donnees personnelles suivantes :
            </p>

            <div className="space-y-4 mt-4">
              <div className="bg-mono-975 dark:bg-[#171717] rounded-xl p-4 border border-mono-900 dark:border-mono-300">
                <h3 className="font-medium text-mono-100 dark:text-white mb-2">3.1.1 Donnees d'identification et de contact</h3>
                <p className="text-mono-350 dark:text-mono-800 text-sm">
              ...
              <div className="bg-mono-975 dark:bg-[#171717] rounded-xl p-4 border border-mono-900 dark:border-mono-300">
                <h3 className="font-medium text-mono-100 dark:text-white mb-2">3.1.2 Donnees de connexion et donnees techniques</h3>
                <p className="text-mono-350 dark:text-mono-800 text-sm">
              ...
              <div className="bg-mono-975 dark:bg-[#171717] rounded-xl p-4 border border-mono-900 dark:border-mono-300">
                <h3 className="font-medium text-mono-100 dark:text-white mb-2">3.1.3 Donnees metier et donnees professionnelles</h3>
                <p className="text-mono-350 dark:text-mono-800 text-sm">
              ...
              <div className="bg-mono-975 dark:bg-[#171717] rounded-xl p-4 border border-mono-900 dark:border-mono-300">
                <h3 className="font-medium text-mono-100 dark:text-white mb-2">3.1.4 Donnees de paiement et donnees de facturation</h3>
                <p className="text-mono-350 dark:text-mono-800 text-sm">
              ...
              <div className="bg-mono-975 dark:bg-[#171717] rounded-xl p-4 border border-mono-900 dark:border-mono-300">
                <h3 className="font-medium text-mono-100 dark:text-white mb-2">3.1.5 Donnees de communication et de support</h3>
                <p className="text-mono-350 dark:text-mono-800 text-sm">
          ...
          <section className="bg-mono-1000 dark:bg-mono-50 border border-mono-900 dark:border-mono-200 rounded-2xl p-6 space-y-3">
            ...
            <p className="text-mono-350 dark:text-mono-800">
              <span className="font-medium text-mono-100 dark:text-white">4.1</span> Les donnees personnelles collectees par la Societe sont traitees pour les finalites suivantes, chacune reposant sur une base legale specifique conformement a l'article 6 du RGPD :
            </p>
              ...
              <table className="w-full text-sm mt-2">
                <thead>
                  <tr className="border-b border-mono-900 dark:border-mono-300">
                    <th className="text-left py-3 px-4 text-mono-500 font-medium">Finalite</th>
                    <th className="text-left py-3 px-4 text-mono-500 font-medium">Base legale</th>
                  </tr>
                </thead>
                <tbody className="text-mono-350 dark:text-mono-800">
          ...
          <section className="bg-mono-1000 dark:bg-mono-50 border border-mono-900 dark:border-mono-200 rounded-2xl p-6 space-y-3">
            ...
            <div className="space-y-4 mt-4">
              ...
              <div className="bg-mono-975 dark:bg-[#171717] rounded-xl p-4 border border-mono-900 dark:border-mono-300">
                <h3 className="font-medium text-mono-100 dark:text-white mb-1">7.1.2 Cookies analytiques et de mesure d'audience</h3>
                <p className="text-mono-350 dark:text-mono-800 text-sm">
              ...
              <div className="bg-mono-975 dark:bg-[#171717] rounded-xl p-4 border border-mono-900 dark:border-mono-300">
                <h3 className="font-medium text-mono-100 dark:text-white mb-1">7.1.3 Cookies fonctionnels</h3>
                <p className="text-mono-350 dark:text-mono-800 text-sm">
          ...
          <section className="bg-mono-1000 dark:bg-mono-50 border border-mono-900 dark:border-mono-200 rounded-2xl p-6 space-y-3">
            ...
            <div className="text-mono-350 dark:text-mono-800 space-y-1">
              <p><span className="text-mono-500">Denomination sociale :</span> RestauMargin SAS</p>
              <p><span className="text-mono-500">Qualite :</span> Responsable du traitement des donnees a caractere personnel</p>
              <p><span className="text-mono-500">Siege social :</span> Marseille, France</p>
